...
export default function CompanyProfilePage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-nafeza-700">{t('dashboard.companyProfile')}</h1>
        <p className="text-sm sm:text-base text-slate-500 mt-1">{t('dashboard.manageCompanyInfo')}</p>
      </div>
