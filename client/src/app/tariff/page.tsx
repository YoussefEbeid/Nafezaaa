...
export default function TariffPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <div className="bg-nafeza-700 text-white py-12 px-4 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
        <div className="max-w-4xl mx-auto relative z-10">
          <button onClick={() => router.push('/')} className="flex items-center text-nafeza-100 hover:text-white mb-4 transition-colors">
            <ArrowLeft className="w-4 h-4 mr-1" /> Back to Home
          </button>
          <h1 className="text-4xl font-bold mb-2">Customs Tariff Search</h1>
          <p className="text-nafeza-200">Look up HS Codes, Duty Rates, and Regulations.</p>
        </div>
      </div>

      <div className="flex-1 max-w-4xl mx-auto w-full px-4 -mt-8 relative z-20 mb-12">
        <Card className="shadow-xl border-0 overflow-hidden">
          ...
          <CardContent className="p-8">
            <div className="space-y-6">
              ...
              {results.length > 0 && (
                <div className="mt-8 border rounded-lg overflow-hidden animate-in fade-in duration-500">
